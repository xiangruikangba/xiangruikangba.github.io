    ...
    if (!e.jQuery) {
        ...
        n.isWindow = function(e) {
            ...
            if (r) {
                ...
                for (s in e)
                    if (i = n.call(e[s], s, e[s]), i === !1) break; return e
...
function(e) {
    ...
    }(window, document, jQuery), define("fancy", function() {}),
    function(e) {
        var t = e.fancybox;
        t.helpers.thumbs = {
            defaults: {
    ...
    }(jQuery), define("fancyThumb", ["jquery", "fancy"], function() {}),
    function(e) {
        var t = {},
            n, r, i = document,
            s = window,
        ...
        e.event.special.inview = {
            ...
            if (l = u.length) {
                ...
                if (!(v = n)) {
                    ...
                    !m.height && ((v = i.compatMode) || !e.support.boxModel) && (v = "CSS1Compat" === v ? o : i.body, m = {
    ...
    }(), define("SmoothScroll", function() {}), ! function(e) {
    ...
    function(e) {
        e.fn.matchHeight = function(t) {
            ...
            return n && (s.each(function() {
                ...
                o.css({
                    ...
                    var t = e(this),
                        n = 0;
                    "border-box" !== t.css("box-sizing") && (n += i(t.css("border-top-width")) + i(t.css("border-bottom-width")), n += i(t.css("padding-top")) + i(t.css("padding-bottom"))), t.css("height", s - n)
                })
            }), e.fn.matchHeight._maintainScroll && e(window).scrollTop(u / a * e("html").outerHeight(!0)), this
        ...
        }, e.fn.matchHeight._groups = [], e.fn.matchHeight._throttle = 80, e.fn.matchHeight._maintainScroll = !1;
        var t = -1,
            n = -1;
        ...
        var r = function(t) {
                ...
                return e(t).each(function() {
                    ...
                    null === o ? r.push(t) : 1 >= Math.floor(Math.abs(n - s)) ? r[r.length - 1] = o.add(t) : r.push(t), n = s
                }), r
            },
            i = function(e) {
                return parseFloat(e) || 0
            }
    }(jQuery), define("matchH", function() {}), ! function(e) {
        var t = "waitForImages";
        e.waitForImages = {
    ...
    }(jQuery), define("waitImg", function() {}), define("components/basicBind", ["underscore", "jquery", "fancy", "fancyThumb", "inView", "SmoothScroll", "velocity", "velocityUi", "matchH", "waitImg"], function(e, t) {
        var n = {
            select: {
            ...
            bindUiActions: function() {
                t(".stats-item").css("opacity", "0"), this.bindTeamHover(), this.bindMapToggle(), t(".news-section").waitForImages(function() {
                    n.matchNewsHeight()
                }), n.setLogoHeight(), t(window).resize(e.debounce(function() {
                    n.setLogoHeight(), n.matchNewsHeight(), n.setTopPadding()
                }, 500)), setInterval(function() {
                    n.animateWhyus()
                }, 3e3), t(".js-procede-btn").click(function() {
            ...
            setTopPadding: function() {
                t(".parallax-header").length && t(".page-content").css("padding-top", t(window).innerHeight() + "px"), t(".js-bgi-v").length && t(".js-bgi-v").css("height", t(window).innerHeight() + "px")
            },
            animateWhyus: function() {
                var e = t(".why-us-image");
                e.hasClass("left-side") ? e.removeClass("left-side").addClass("right-side") : e.hasClass("right-side") ? e.removeClass("right-side") : e.addClass("left-side")
            },
            ...
            setLogoHeight: function() {
                t(".logo-img").css("max-height", t(window).innerHeight() * .6), t(".logo-img").css({
                    "max-height": t(window).innerHeight() * .6,
                    "max-width": t(window).innerWidth() * .85
                })
            },
            bindMapToggle: function() {
                t(".js-map-container").velocity({
                    translateY: "-130%"
                }, 10), t(".js-map-view").on("click tap", function() {
                    t(".js-map-container").velocity({
                        translateY: ["0", "-130%"]
                    }, 700, function() {
                    ...
                    e.preventDefault(), e.keyCode === 27 && t(".js-map-container").hasClass("is-active") && t(".js-map-container").removeClass("is-active").velocity("reverse")
                })
            },
            bindTeamHover: function() {
                t(".about-team").hover(function() {
                    t(".js-item-info", t(this)).stop().velocity("stop").velocity({
                        opacity: "0"
                    }, 250), t(".team-social", t(this)).stop().delay(250).each(function(e) {
                        t(this).velocity("stop").velocity({
                            translateY: ["0", "-20"],
                            opacity: ["1", "0"]
                        }, {
                            duration: 250,
                            delay: e + "00",
                            easing: [.175, .885, .32, 1.575]
                        })
                    })
                }, function() {
                    t(".js-item-info", t(this)).stop().velocity("stop").velocity({
                        ...
                        duration: 250,
                        delay: 200
                    }), t(".team-social", t(this)).stop().velocity("stop").velocity({
                        translateY: "-20px",
                        opacity: "0"
                    }, 250)
                })
            ...
            animNumbers: function() {
                t("#hours").animateNumbers(24, !0, n.select.numbersTime, "linear"), t("#sold").animateNumbers(2443, !0, n.select.numbersTime, "linear"), t("#happy").animateNumbers(98, !0, n.select.numbersTime, "linear"), t("#experience").animateNumbers(20, !0, n.select.numbersTime, "linear")
            },
    ...
    }(window.Zepto || window.jQuery, window, document), define("owlCarousel", function() {}), define("components/sliderScript", ["domReady", "underscore", "jquery", "owlCarousel", "matchH", "waitImg"], function(e, t, n) {
        var r = {
            select: {
            ...
            bindUiActions: function() {
                this.initPartnersFlex(), this.initReviewsSlider(), this.initNewsSlider()
            },
            initNewsSlider: function() {
                ...
                r.initCarousel(this.select.news, e), this.select.news.waitForImages(function() {
                    n(window).resize(t.debounce(function() {
                        n(".owl-item", r.select.news).height(n(".news-image-block").height())
                    }, 250)), n(".owl-item", r.select.news).height(n(".news-image-block").height())
                })
            },
            initReviewsSlider: function() {
                ...
                n(".testimonial-item").matchHeight(), r.initCarousel(this.select.reviews, e)
            },
    ...
    function(e) {
        e.fn.bPopup = function(t, n) {
            function r() {
                ...
                switch (v.content) {
                    case "iframe":
                        var t = e('<iframe class="b-iframe" ' + v.iframeAttr + "></iframe>");
                        t.appendTo(v.contentContainer), D = m.outerHeight(!0), P = m.outerWidth(!0), i(), t.attr("src", v.loadUrl), h(v.loadCallback);
                        break;
                    case "image":
                        i(), e("<img />").load(function() {
                            h(v.loadCallback), o(e(this))
                        }).attr("src", v.loadUrl).hide().appendTo(v.contentContainer);
                        break;
                    default:
                        i(), e('<div class="b-ajax-wrapper"></div>').load(v.loadUrl, v.loadData, function() {
                            h(v.loadCallback), o(e(this))
                        }).hide().appendTo(v.contentContainer)
                }
            }

            function i() {
                v.modal && e('<div class="b-modal ' + C + '"></div>').css({
                    ...
                    opacity: 0,
                    zIndex: v.zIndex + N
                }).appendTo(v.appendTo).fadeTo(v.speed, v.opacity), p(), m.data("bPopup", v).data("id", C).css({
                    left: "slideIn" == v.transition || "slideBack" == v.transition ? "slideBack" == v.transition ? g.scrollLeft() + S : -1 * (_ + P) : l(!(!v.follow[0] && A || O)),
                    position: v.positionStyle || "absolute",
                    top: "slideDown" == v.transition || "slideUp" == v.transition ? "slideUp" == v.transition ? g.scrollTop() + E : M + -1 * D : c(!(!v.follow[1] && L || O)),
            ...
            function s() {
                return v.modal && e(".b-modal." + m.data("id")).fadeTo(v.speed, 0, function() {
                    e(this).remove()
                }), v.scrollBar || e("html").css("overflow", "auto"), e(".b-modal." + C).unbind("click"), g.unbind("keydown." + C), w.unbind("." + C).data("bPopup", 0 < w.data("bPopup") - 1 ? w.data("bPopup") - 1 : null), m.undelegate(".bClose, ." + v.closeClass, "click." + C, s).data("bPopup", null), a(), !1
            }
            ...
            function o(e) {
                var t = e.width(),
                    n = e.height(),
                    r = {};
                v.contentContainer.css({
                    height: n,
                    width: t
                }), n >= m.height() && (r.height = m.height()), t >= m.width() && (r.width = m.width()), D = m.outerHeight(!0), P = m.outerWidth(!0), p(), v.contentContainer.css({
                    height: "auto",
                    width: "auto"
                }), r.left = l(!(!v.follow[0] && A || O)), r.top = c(!(!v.follow[1] && L || O)), m.animate(r, 250, function() {
                    e.show(), k = d()
                })
            }

            function u() {
                w.data("bPopup", N), m.delegate(".bClose, ." + v.closeClass, "click." + C, s), v.modalClose && e(".b-modal." + C).css("cursor", "pointer").bind("click", s), x || !v.follow[0] && !v.follow[1] || w.bind("scroll." + C, function() {
                    k && m.dequeue().animate({
                        left: v.follow[0] ? l(!O) : "auto",
                        top: v.follow[1] ? c(!O) : "auto"
                    }, v.followSpeed, v.followEasing)
                }).bind("resize." + C, function() {
                    E = y.innerHeight || w.height(), S = y.innerWidth || w.width();
                    if (k = d()) clearTimeout(H), H = setTimeout(function() {
                        p(), m.dequeue().each(function() {
                            O ? e(this).css({
                                left: _,
                                top: M
                            }) : e(this).animate({
                ...
                }), v.escClose && g.bind("keydown." + C, function(e) {
                    27 == e.which && s()
                })
            }
            ...
            function a(e) {
                function t(t) {
                    m.css({
                        display: "block",
                        opacity: 1
                    }).animate(t, v.speed, v.easing, function() {
                        f(e)
                    })
                }
                switch (e ? v.transition : v.transitionClose || v.transition) {
                    case "slideIn":
                        t({
                            left: e ? l(!(!v.follow[0] && A || O)) : g.scrollLeft() - (P || m.outerWidth(!0)) - T
                        });
                        break;
                    case "slideBack":
                        t({
                    ...
                    case "slideDown":
                        t({
                            top: e ? c(!(!v.follow[1] && L || O)) : g.scrollTop() - (D || m.outerHeight(!0)) - T
                        });
                        break;
                    case "slideUp":
                        t({
            ...
            function f(e) {
                e ? (u(), h(n), v.autoClose && setTimeout(s, v.autoClose)) : (m.hide(), h(v.onClose), v.loadUrl && (v.contentContainer.empty(), m.css({
                    height: "auto",
                    width: "auto"
                })))
            }
            ...
            function p() {
                M = L ? v.position[1] : Math.max(0, (E - m.outerHeight(!0)) / 2 - v.amsl), _ = A ? v.position[0] : (S - m.outerWidth(!0)) / 2, k = d()
            }
            ...
            return m.close = function() {
                v = this.data("bPopup"), C = "__b-popup" + w.data("bPopup") + "__", s()
            }, m.each(function() {
                e(this).data("bPopup") || (h(v.onOpen), N = (w.data("bPopup") || 0) + 1, C = "__b-popup" + N + "__", L = "auto" !== v.position[1], A = "auto" !== v.position[0], O = "fixed" === v.positionStyle, D = m.outerHeight(!0), P = m.outerWidth(!0), v.loadUrl ? r() : i())
            })
    ...
    }(jQuery), define("bPopup", function() {}), define("components/getinTouch", ["jquery", "bPopup", "velocity", "velocityUi"], function(e) {
        var t = {
            data: {
            ...
            bindUiActions: function() {
                e("form").submit(function(e) {
                    ...
                    e(this).hasClass("preorder-btn") && e(window).trigger("fillField"), t.validateForm(e(this))
            ...
            validateForm: function(n) {
                ...
                }), r ? t.sendForm(i) : i.parent().hasClass("products-form-block") ? n.velocity("callout.shake", 500) : t.bindPopup(t.data.error)
            },
            sendForm: function(n) {
                var r = "sendmail.php";
                return e.ajax({
                    ...
                    success: function() {
                        ...
                        n.parent().hasClass("products-form-block") ? e(window).trigger("orderSent") : t.bindPopup(t.data.succes)
                    }
                }), !1
            },
        ...
        t.init()
    }), define("components/customSelect", ["jquery", "velocity", "velocityUi"], function(e) {
        var t = {
            select: {
                dropdown: e(".select"),
            ...
            closeDropdown: function(n) {
                e(".category-list", t.select.container).hasClass("changing") || (n ? n.parents().hasClass("select") || t.select.container.each(function() {
            ...
            toggleOpen: function() {
                t.select.container.hasClass("active") ? t.select.container.removeClass("active") : (t.select.container.each(function() {
                    t.select.container.removeClass("active")
                }), t.select.container.addClass("active"), e(".category-item").css("opacity", "0").velocity("transition.slideLeftIn", {
                    stagger: 150,
                    delay: 500
                }))
            },
            setValue: function(t, n, r) {
                ...
                e("dt a span", r).html(n), e("input", r).length && e("input", r).val(i)
            }
        };
        t.init()
        ...
        return e
    }), define("components/headerScript", ["jquery", "owlCarousel", "underscore", "domReady"], function(e, t, n) {
        var r = {
            select: {
                header: e(".header-carousel"),
                vbg: e(".video-bg-wrapper")
            },
            init: function() {
                this.bindUiActions()
            },
            bindUiActions: function() {
                e(".header-carousel").length && (r.initHeaderFlex(), e(window).resize(n.debounce(function() {
                    r.setItemsHeight(), r.resizeHeaderImages()
                }, 500))), e(".video-bg-wrapper").length && (r.setVbgHeight(), r.checkVideoSize(), e(window).resize(n.debounce(function() {
            ...
            initHeaderFlex: function() {
                this.select.header.on("initialized.owl.carousel", function() {
                    r.createPaginationDummy(), r.setItemsHeight(), r.resizeHeaderImages()
                });
                var e = {
                ...
                r.initCarousel(this.select.header, e), this.select.header.on("changed.owl.carousel", function() {
                    r.initPagination()
                })
            },
            setItemsHeight: function() {
                e(".owl-item", r.select.header).css("height", e(window).innerHeight())
            },
            resizeHeaderImages: function() {
                e("img", r.select.header).each(function() {
                    ...
                    if (t < n) {
                        ...
                        if (e(this).width() === 0) setTimeout(function() {
            ...
            createPaginationDummy: function() {
                r.select.header.find(".owl-controls").append('<div class="dummy">'), r.initPagination()
            },
            initPagination: function() {
                ...
                t === 0 ? n.animate({
                    ...
                    top: t + "px"
                }, 500), e(".owl-dot", r.select.header).click(function() {
        ...
        var t = {
            ...
            bindControll: function() {
                t.get.playBtn.on("click tap", function(n) {
                    n.preventDefault(), e(this).toggleClass("playing"), e(this).hasClass("playing") ? t.get.video.trigger("play") : t.get.video.trigger("pause")
                })
            }
        };
        t.init()
        ...
        var t = {
            ...
            bindUiActions: function() {
                t.appendNavsForMobile(), t.get.toggleBtn.click(function() {
                    t.toggleMenu()
                }), e(".menu-item", t.get.navContainer).click(function() {
                    t.get.toggleBtn.removeClass("is-active"), t.get.navContainer.removeClass("is-active")
                })
            },
            appendNavsForMobile: function() {
                t.get.navList.clone().appendTo(t.get.navContainer), e(".menu-item", t.get.navContainer).each(function() {
                    e(this).on("click tap", function(t) {
                        t.preventDefault();
                        var n = e("a", e(this)).attr("href"),
                            r = e(n).offset().top;
            ...
            toggleMenu: function() {
                e(".menu-item", t.get.navContainer).css("opacity", "0").velocity("stop").velocity("transition.slideDownIn", {
                    stagger: 100
                }), t.get.navContainer.toggleClass("is-active"), t.get.toggleBtn.toggleClass("is-active")
            }
        };
        t.init()
        ...
        var t = {
            ...
            n = {
                ...
                bindUiActions: function() {
                    this.revealProducts(), this.revealTeam(), this.revealNews(), this.revealList(), this.revealFooter(), this.revealWhy()
                },
                revealWhy: function() {
                    t.$why.one("inview", function() {
                        e(".left-info-block").find(t.$why).velocity("transition.slideLeftBigIn", {
                            stagger: 200,
                            delay: 100,
                            duration: 1e3
                        }), e(".right-info-block").find(t.$why).velocity("transition.slideRightBigIn", {
                            stagger: 200,
                            delay: 100,
                            duration: 1e3
                        })
    ...
    }), define("components/preloader", ["domReady", "underscore", "jquery", "components/reveal", "velocity", "velocityUi", "waitImg"], function(e, t, n, r) {
        var i = {
            get: {
            ...
            bindUiActions: function() {
                n(".color-wave").length && i.createCanvasPreloader(), e(function() {
            ...
            closePreloader: function() {
                n(window).trigger("Reveal"), n(".js-video-bg").trigger("play"), i.get.container.parent().velocity({
                    translateX: "100%"
                }, 700, function() {
            ...
            prepareElementsForEnter: function() {
                n(".menu-item").css("opacity", "0"), n(".js-slidedown-reveal").css("opacity", "0")
            },
            enterElements: function() {
                ...
                }, 1e3), n(".menu-item").velocity("transition.slideDownBigIn", {
                    duration: 500,
                    stagger: 150
                })
            },
            createCanvasPreloader: function() {
                ...
                i.get.image.width(r + 2).height(s / 2), n(".color-wave").width(r).height(s / 2), t.lineJoin = "round", t.lineWidth = a.thickness, t.strokeStyle = a.strokeColor;
                var c = function(e) {
                    this.anchorX = e.x, this.anchorY = e.y, this.x = e.x, this.y = e.y, this.setTarget()
                };
                c.prototype.setTarget = function() {
                    this.initialX = this.x, this.initialY = this.y, this.targetX = this.anchorX + f(0, a.range.x * 2) - a.range.x, this.targetY = this.anchorY + f(0, a.range.y * 2) - a.range.y, this.tick = 0, this.duration = f(a.duration.min, a.duration.max)
                    ...
                    if (Math.abs(n) <= 0) this.setTarget();
                        ...
                        var r = this.tick,
                            ...
                            o = this.duration;
                        this.y = l(r, i, s, o), i = this.initialX, s = this.targetX - this.initialX, o = this.duration, this.x = l(r, i, s, o), this.tick++
                    }
                }, c.prototype.render = function() {
                    t.beginPath(), t.arc(this.x, this.y, 3, 0, Math.PI * 2, !1), t.fillStyle = "#000", t.fill()
                };
                var h = function() {
                        var e = o.length;
                        while (e--) o[e].update()
                    ...
                    d = function() {
                        ...
                        t.lineTo(-a.range.x - a.thickness, s + a.thickness), t.lineTo(r + a.range.x + a.thickness, s + a.thickness), t.closePath(), t.fillStyle = "hsl(" + u / 2 + ", 70%, 60%)", t.fill()
                    },
                    v = function() {
                        t.clearRect(0, 0, r, s)
                    },
    ...
    function(e) {
        ...
        function p(e) {
            ...
            var s = Date.parse(e);
            return isNaN(s) ? (s = Date.parse(e.replace(/-/g, "/").replace("T", " ")), isNaN(s) ? new Date : s) : s
        }
        ...
        function d(e, t, n, r, i) {
            ...
            for (var p = 0; p < r.length; p++) {
                ...
                var m = e / a[d],
                    g = t / a[d];
                i && (m > 0 ? m = Math.floor(m) : m = Math.ceil(m), g > 0 ? g = Math.floor(g) : g = Math.ceil(g)), d !== "Days" && (m %= v, g %= v), s[d] = m, u[d] = Math.abs(m), o[d] = g, c[d] = Math.abs(g), f[d] = Math.abs(m) / v, l[d] = Math.abs(g) / v, h = d
            }
            return {
                raw_time: s,
                raw_old_time: o,
        ...
        function m() {
            typeof t.TC_Instance_List != "undefined" ? v = t.TC_Instance_List : t.TC_Instance_List = v, g(t)
        }

        function g(e) {
            var t = ["webkit", "moz"];
            for (var n = 0; n < t.length && !e.requestAnimationFrame; ++n) e.requestAnimationFrame = e[t[n] + "RequestAnimationFrame"], e.cancelAnimationFrame = e[t[n] + "CancelAnimationFrame"];
            if (!e.requestAnimationFrame || !e.cancelAnimationFrame) e.requestAnimationFrame = function(t, n, r) {
        ...
        y.prototype.clearListeners = function() {
            ...
            } else isNaN(this.data.attributes.ref_date) || (this.data.attributes.ref_date += e * 1e3)
            ...
            e(this.element).children("div.time_circles").remove(), typeof r == "undefined" && (r = !0), (r || this.listeners === null) && this.clearListeners(), this.container = e("<div>"), this.container.addClass("time_circles"), this.container.appendTo(this.element);
            var o = this.element.offsetHeight,
                u = this.element.offsetWidth;
            o === 0 && (o = e(this.element).height()), u === 0 && (u = e(this.element).width()), o === 0 && u > 0 ? o = u / this.data.drawn_units.length : u === 0 && o > 0 && (u = o * this.data.drawn_units.length);
            var a = document.createElement("canvas");
            a.width = u, a.height = o, this.data.attributes.canvas = e(a), this.data.attributes.canvas.appendTo(this.container);
            var f = l();
            !f && typeof G_vmlCanvasManager != "undefined" && (G_vmlCanvasManager.initElement(a), n = !0, f = !0), f && (this.data.attributes.context = a.getContext("2d")), this.data.attributes.item_size = Math.min(u / this.data.drawn_units.length, o), this.data.attributes.line_width = this.data.attributes.item_size * this.config.fg_width, this.data.attributes.radius = (this.data.attributes.item_size * .8 - this.data.attributes.line_width) / 2, this.data.attributes.outer_radius = this.data.attributes.radius + .5 * Math.max(this.data.attributes.line_width, this.data.attributes.line_width * this.config.bg_width);
            var i = 0;
            for (var c in this.data.text_elements) {
                if (!this.config.time[c].show) continue;
                var h = e("<div>");
                h.addClass("textDiv_" + c), h.css("top", Math.round(.35 * this.data.attributes.item_size)), h.css("left", Math.round(i++ * this.data.attributes.item_size)), h.css("width", this.data.attributes.item_size), h.appendTo(this.container);
                var p = e("<h4>");
                p.text(this.config.time[c].text), p.css("font-size", Math.round(this.config.text_size * this.data.attributes.item_size)), p.css("line-height", Math.round(this.config.text_size * this.data.attributes.item_size) + "px"), p.appendTo(h);
                var d = e("<span>");
                d.css("font-size", Math.round(3 * this.config.text_size * this.data.attributes.item_size)), d.css("line-height", Math.round(this.config.text_size * this.data.attributes.item_size) + "px"), d.appendTo(h), this.data.text_elements[c] = d
            }
            ...
            n && this.data.attributes.context.clearRect(0, 0, this.data.attributes.canvas[0].width, this.data.attributes.canvas[0].hright);
            var i, s, u = this.data.prev_time,
                f = new Date;
            ...
            if (!this.config.count_past_zero && f > this.data.attributes.ref_date) {
                for (var l = 0; l < this.data.drawn_units.length; l++) {
                    ...
                    var h = l * this.data.attributes.item_size + this.data.attributes.item_size / 2,
            ...
            i = (this.data.attributes.ref_date - f) / 1e3, s = (this.data.attributes.ref_date - u) / 1e3;
            ...
            for (var l in o) {
                var c = o[l];
                Math.floor(y.raw_time[c]) !== Math.floor(y.raw_old_time[c]) && this.notifyListeners(c, Math.floor(y.time[c]), Math.floor(i), "all");
                if (E.indexOf(c) < 0) continue;
                Math.floor(g.raw_time[c]) !== Math.floor(g.raw_old_time[c]) && this.notifyListeners(c, Math.floor(g.time[c]), Math.floor(i), "visible");
                if (!e) {
                    ...
                    var h = b * this.data.attributes.item_size + this.data.attributes.item_size / 2,
                        p = this.data.attributes.item_size / 2,
                        v = this.config.time[c].color;
                    this.config.animation === "smooth" ? (w !== null && !n && (Math.floor(g.time[w]) > Math.floor(g.old_time[w]) ? (this.radialFade(h, p, v, 1, c), this.data.state.fading[c] = !0) : Math.floor(g.time[w]) < Math.floor(g.old_time[w]) && (this.radialFade(h, p, v, 0, c), this.data.state.fading[c] = !0)), this.data.state.fading[c] || this.drawArc(h, p, v, g.pct[c])) : this.animateArc(h, p, v, g.pct[c], g.old_pct[c], (new Date).getTime() + r)
                }
                w = c, b++
            }
            ...
            if (this.config.animation === "smooth") this.data.animation_frame = t.requestAnimationFrame(x, S.element, S);
            else {
                var T = i % 1 * 1e3;
                T < 0 && (T = 1e3 + T), T += 50, S.data.animation_frame = t.setTimeout(function() {
            ...
            var a = o - s;
            if (Math.abs(a) > .5) s === 0 ? this.radialFade(e, n, i, 1) : this.radialFade(e, n, i, 0);
            else {
            ...
            n || this.data.attributes.context.clearRect(e - s, t - s, s * 2, s * 2), this.config.use_background && (this.data.attributes.context.beginPath(), this.data.attributes.context.arc(e, t, this.data.attributes.radius, 0, 2 * Math.PI, !1), this.data.attributes.context.lineWidth = this.data.attributes.line_width * this.config.bg_width, this.data.attributes.context.strokeStyle = this.config.circle_bg_color, this.data.attributes.context.stroke());
            var o, u, a, f = -0.5 * Math.PI,
                l = 2 * Math.PI;
            o = f + this.config.start_angle / 360 * l;
            var c = 2 * i * Math.PI;
            this.config.direction === "Both" ? (a = !1, o -= c / 2, u = o + c) : this.config.direction === "Clockwise" ? (a = !1, u = o + c) : (a = !0, u = o - c), this.data.attributes.context.beginPath(), this.data.attributes.context.arc(e, t, this.data.attributes.radius, o, u, a), this.data.attributes.context.lineWidth = this.data.attributes.line_width, this.data.attributes.context.strokeStyle = r, this.data.attributes.context.stroke()
        }, y.prototype.radialFade = function(e, n, r, i, s) {
            var o = f(r),
                u = this,
                a = .2 * (i === 1 ? -1 : 1),
                l;
            for (l = 0; i <= 1 && i >= 0; l++)(function() {
                var r = 50 * l,
                    s = "rgba(" + o.r + ", " + o.g + ", " + o.b + ", " + Math.round(i * 10) / 10 + ")";
                t.setTimeout(function() {
                    u.drawArc(e, n, s, 1)
                }, r)
            })(), i += a;
            typeof s !== undefined && t.setTimeout(function() {
            ...
            t.cancelAnimationFrame(this.data.animation_frame), t.clearTimeout(this.data.animation_frame);
            ...
            else if (typeof this.data.timer == "number") this.data.paused && (this.data.attributes.ref_date = (new Date).getTime() + this.data.timer * 1e3);
            else {
                var r = e(this.element).data("timer");
                typeof r == "undefined" && (r = e(this.element).attr("data-timer")), typeof r == "string" && (r = parseFloat(r)), typeof r == "number" ? (this.data.timer = r, this.data.attributes.ref_date = (new Date).getTime() + r * 1e3) : this.data.attributes.ref_date = this.config.ref_date
            }
            this.data.paused = !1, this.update.call(this)
        }, y.prototype.restart = function() {
            this.data.timer = !1, this.start()
        }, y.prototype.stop = function() {
            typeof this.data.timer == "number" && (this.data.timer = this.timeLeft(this)), this.data.paused = !0, t.cancelAnimationFrame(this.data.animation_frame)
        }, y.prototype.destroy = function() {
            this.clearListeners(), this.stop(), t.clearInterval(this.data.interval_fallback), this.data.interval_fallback = null, this.container.remove(), e(this.element).removeAttr("data-tc-id"), e(this.element).removeData("tc-id")
        }, y.prototype.setOptions = function(n) {
            this.config === null && (this.default_options.ref_date = new Date, this.config = e.extend(!0, {}, this.default_options)), e.extend(!0, this.config, n), this.config.use_top_frame ? t = window.top : t = window, m(), this.data.total_duration = this.config.total_duration;
            if (typeof this.data.total_duration == "string")
                if (typeof a[this.data.total_duration] != "undefined") this.data.total_duration = a[this.data.total_duration];
                ...
                } else this.data.total_duration = a.Years, console.error("Valid values for TimeCircles config.total_duration are either numeric, or (string) Years, Months, Days, Hours, Minutes, Auto")
        }, y.prototype.addListener = function(e, t, n) {
            if (typeof e != "function") return;
            typeof n == "undefined" && (n = "visible"), this.listeners[n].push({
                func: e,
                scope: t
            })
        ...
        b.prototype.getInstance = function(t) {
            var n, r = e(t).data("tc-id");
            typeof r == "undefined" && (r = h(), e(t).attr("data-tc-id", r));
            if (typeof v[r] == "undefined") {
                var i = this.options,
                    s = e(t).data("options");
                typeof s == "string" && (s = JSON.parse(s)), typeof s == "object" && (i = e.extend(!0, {}, this.options, s)), n = new y(t, i), v[r] = n
            } else n = v[r], typeof this.options != "undefined" && n.setOptions(this.options);
            return n
    ...
    }(jQuery), define("circleTimer", function() {}), define("components/timer", ["jquery", "underscore", "circleTimer"], function(e, t) {
        var n = {
                timer: e(".countdown-block"),
                color: e(".theme-bg-c").css("background-color").replace(/,|rgb|\(|\)/g, "").split(" "),
                timeColor: null
            },
            r = {
                init: function() {
                ...
                getThemeColor: function() {
                    ...
                    n.timeColor = t(parseInt(n.color[0]), parseInt(n.color[1]), parseInt(n.color[2]))
                },
                initTimer: function() {
                    n.timer.TimeCircles({
                        animation: "smooth",
                        bg_width: .7,
                        fg_width: .013333333333333334,
                    ...
                    }), e(window).resize(t.debounce(function() {
        ...
        return {
            ...
            items: [{
                ...
                thumb: "thumb1.jpg",
                gallery: ["prod1-1.jpg", "prod1-2.jpg", "prod1-3.jpg"]
            }, {
                ...
                thumb: "thumb2.jpg",
                gallery: ["prod2-1.jpg", "prod2-2.jpg", "prod2-3.jpg"]
            }, {
                name: "Cayler And Sons Milano Backpack",
                price: {
                    current: "38.00",
                ...
                thumb: "thumb3.jpg",
                gallery: ["prod3-1.jpg", "prod3-2.jpg", "prod3-3.jpg"],
                label: {
                    text: "sale"
                }
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb4.jpg",
                gallery: ["prod4-1.jpg", "prod4-2.jpg", "prod4-3.jpg"]
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb5.jpg",
                gallery: ["prod5-1.jpg", "prod5-2.jpg", "prod5-3.jpg"],
                label: {
                    icon: "fa-money",
                    text: "50% off"
                }
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb6.jpg",
                gallery: ["prod6-1.jpg", "prod6-2.jpg", "prod6-3.jpg"]
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb7.jpg",
                gallery: ["prod7-1.jpg", "prod7-2.jpg", "prod7-3.jpg"]
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb8.jpg",
                gallery: ["prod8-1.jpg", "prod8-2.jpg", "prod8-3.jpg"],
                label: {
                    icon: "fa-star",
                    text: "top rated"
                }
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb9.jpg",
                gallery: ["prod9-1.jpg", "prod9-2.jpg", "prod9-3.jpg"]
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb10.jpg",
                gallery: ["prod10-1.jpg", "prod10-2.jpg", "prod10-3.jpg"]
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb12.jpg",
                gallery: ["prod12-1.jpg", "prod12-2.jpg", "prod12-3.jpg"]
            }, {
                name: "Reclaimed Vintage African Bum Bag",
                price: {
                    current: "79.00",
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb13.jpg",
                gallery: ["prod13-1.jpg", "prod13-2.jpg", "prod13-3.jpg"]
            }, {
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb14.jpg",
                gallery: ["prod14-1.jpg", "prod14-2.jpg", "prod14-3.jpg"]
            }]
        }
        ...
        return {
            ...
            items: [{
                ...
                details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
                thumb: "thumb11.jpg",
                gallery: ["prod11-1.jpg", "prod11-2.jpg", "prod11-3.jpg"]
            }, {
                name: "Plimsolls",
                price: {
                    current: "25.00"
    ...
    }), define("products/defineCategories", ["products/categories/bags", "products/categories/jeans", "products/categories/shirts", "products/categories/shoes", "products/categories/shorts", "products/categories/t-shirts"], function() {
        var e = [];
    ...
    function(e, t) {
        ...
        return e
    }), define("products/collection/categoryCollection", ["products/models/categoryModel", "jquery", "backbone", "underscore"], function(e) {
        ...
        var e = Backbone.View.extend({
            tagName: "ul",
            template: _.template(['<li class="category-item js-category-item" data-target="<%= cid %>">', '<span class="category-text"><%= name %></span>', "</li>"].join("")),
            initialize: function() {
                var e = this;
                e.collection.forEach(function(t) {
                    var n = _.extend(t.toJSON(), {
                        cid: t.cid
                    });
        ...
        var t = e.View.extend({
            ...
            initialize: function() {
                ...
                e.$el.append(e.template(t)), $(".js-view-product", e.$el).click(function() {
                    ...
                    e.appendTo($(this)), setTimeout(function() {
                        $(e, $(this)).remove()
                    }, 1e3)
                }), $(".currency", e.$el).html($("body").data("currency"))
            },
        ...
        return e
    }), define("products/views/categorySliderView", ["backbone", "products/views/itemView", "products/models/itemModel"], function(e, t, n) {
        var r = e.View.extend({
            tagName: "div",
            ...
            initialize: function() {
                var e = this,
                    r = [];
                e.$el.attr("data-target", e.model.cid).append(e.template()), e.model.get("items").forEach(function(i) {
                    var s = new n;
                    s.set(i);
                    if (e.model.get("addCodePath")) var o = e.model.get("imagesPath") + i.code + "/";
                    else var o = e.model.get("imagesPath");
                    s.set({
                        path: o
                    }), window.ItemsCollection.add(s);
                    var u = new t({
                        model: s
                    });
                    r.push(u.render().el)
                }), e.model.get("oneRow") ? (e.$el.find(".slides").append(r), e.$el.find(".prod-item").wrap("<li></li>")) : e.wrapElements(r), $(".currency", e.$el).html($("body").data("currency"))
            },
            wrapElements: function(e) {
                var t = "",
                    ...
                    r = e.length;
                $.each(e, function(e, i) {
                    e % 2 === 0 ? (t = $("<li>"), t.append(i)) : (t.append(i), n.$el.find(".slides").append(t)), e === r - 1 && r % 2 !== 0 && n.$el.find(".slides").append(t)
                })
            },
            render: function() {
                return this
        ...
        return r
    }), define("products/collection/itemsCollection", ["products/models/itemModel", "backbone", "underscore"], function(e) {
        var t = Backbone.Collection.extend({
            model: e
        });
        return t
        ...
        return t
    }), define("products/views/formView", ["backbone", "underscore", "velocity", "velocityUi"], function() {
        var e = Backbone.View.extend({
            tagName: "ul",
            className: "order-list js-order-list",
            template: _.template(['<li class="order-item js-order-item">', '<span class="order-name"><%= name %></span>', '<span class="order-price js-order-price">', '<span class="currency"></span>', '<span class="value"><%= price %></span>', "</span>", '<span class="remove-item-btn fa fa-trash js-remove-prod" data-selfid="<%= cid %>"></span>', "</li>"].join("")),
            initialize: function() {
                var e = this;
                e.collection.forEach(function(t) {
                    var n = _.extend(t.toJSON(), {
                    ...
                    e.collection.remove(e.collection.get({
                    ...
                    $(".js-order-price .value", $(this)).html(parseFloat(e).toFixed(2))
                }), $(".currency", e.$el).html($("body").data("currency"))
            },
            render: function() {
                return this
        ...
        "function" == typeof define && define.amd ? define("scroll", ["jquery"], e) : "object" == typeof exports ? module.exports = e : e(jQuery)
    }(function(e) {
        function t(t) {
    ...
    function(e, t, n) {
        (function(e) {
            ...
            var r = "mCustomScrollbar",
                ...
                p = {
                    init: function(e) {
                        ...
                        return e.setWidth = e.set_width ? e.set_width : e.setWidth, e.setHeight = e.set_height ? e.set_height : e.setHeight, e.axis = e.horizontalScroll ? "x" : d._findAxis.call(null, e.axis), e.scrollInertia = e.scrollInertia < 17 ? 17 : e.scrollInertia, typeof e.mouseWheel != "object" && e.mouseWheel == 1 && (e.mouseWheel = {
                            enable: !0,
                            scrollAmount: "auto",
                            axis: "y",
                            preventDefault: !1,
                            ...
                            if (!t.data(i)) {
                                ...
                                var r = t.data(i).opt,
                                    ...
                                    a = t.data("mcs-theme");
                                s && (r.axis = s), o && (r.scrollbarPosition = o), a && (r.theme = a, d._theme.call(null, r)), d._pluginMarkup.call(this), p.update.call(null, t)
                            }
                        })
                    },
                    update: function(e) {
                        ...
                        return n(t).each(function() {
                            ...
                            if (e.data(i)) {
                                var t = e.data(i),
                                    ...
                                    o = [n("#mCSB_" + t.idx + "_dragger_vertical"), n("#mCSB_" + t.idx + "_dragger_horizontal")];
                                if (!s.length) return;
                                t.tweenRunning && d._stop.call(null, e), e.hasClass("mCS_disabled") && e.removeClass("mCS_disabled"), e.hasClass("mCS_destroyed") && e.removeClass("mCS_destroyed"), d._maxHeight.call(this), d._expandContentHorizontally.call(this), r.axis !== "y" && !r.advanced.autoExpandHorizontalScroll && s.css("width", d._contentWidth(s.children())), t.overflowed = d._overflowed.call(this), d._scrollbarVisibility.call(this), r.autoDraggerLength && d._setDraggerLength.call(this), d._scrollRatio.call(this), d._bindEvents.call(this);
                                var u = [Math.abs(s[0].offsetTop), Math.abs(s[0].offsetLeft)];
                                r.axis !== "x" && (t.overflowed[0] ? o[0].height() > o[0].parent().height() ? d._resetContentPosition.call(this) : d._scrollTo.call(this, e, u[0].toString(), {
                                    dir: "y",
                                    dur: 0,
                                    overwrite: "none"
                                }) : (d._resetContentPosition.call(this), r.axis === "y" ? d._unbindEvents.call(this) : r.axis === "yx" && t.overflowed[1] && d._scrollTo.call(this, e, u[1].toString(), {
                                    dir: "x",
                                    dur: 0,
                                    overwrite: "none"
                                }))), r.axis !== "y" && (t.overflowed[1] ? o[1].width() > o[1].parent().width() ? d._resetContentPosition.call(this) : d._scrollTo.call(this, e, u[1].toString(), {
                                    dir: "x",
                                    dur: 0,
                                    overwrite: "none"
                                }) : (d._resetContentPosition.call(this), r.axis === "x" ? d._unbindEvents.call(this) : r.axis === "yx" && t.overflowed[0] && d._scrollTo.call(this, e, u[0].toString(), {
                                    dir: "y",
                                    dur: 0,
                                    overwrite: "none"
                    ...
                    scrollTo: function(e, t) {
                        ...
                        return n(r).each(function() {
                            ...
                            if (r.data(i)) {
                                ...
                                f[0] = d._to.call(this, f[0], "y"), f[1] = d._to.call(this, f[1], "x"), a.moveDragger && (f[0] *= s.scrollRatio.y, f[1] *= s.scrollRatio.x), a.dur = l, setTimeout(function() {
                                    f[0] !== null && typeof f[0] != "undefined" && o.axis !== "x" && s.overflowed[0] && (a.dir = "y", a.overwrite = "all", d._scrollTo.call(this, r, f[0].toString(), a)), f[1] !== null && typeof f[1] != "undefined" && o.axis !== "y" && s.overflowed[1] && (a.dir = "x", a.overwrite = "none", d._scrollTo.call(this, r, f[1].toString(), a))
                                }, 60)
                            }
                        })
                    },
                    ...
                    disable: function(e) {
                        ...
                        return n(t).each(function() {
                            ...
                            if (t.data(i)) {
                                var r = t.data(i),
                                    s = r.opt;
                                d._autoUpdate.call(this, "remove"), d._unbindEvents.call(this), e && d._resetContentPosition.call(this), d._scrollbarVisibility.call(this, !0), t.addClass("mCS_disabled")
                            }
                        })
                    },
                    destroy: function() {
                        ...
                        return n(e).each(function() {
                            ...
                            if (t.data(i)) {
                                ...
                                o.live && l(e), d._autoUpdate.call(this, "remove"), d._unbindEvents.call(this), d._resetContentPosition.call(this), t.removeData(i), d._delete.call(null, this.mcs), f.remove(), u.replaceWith(a.contents()), t.removeClass(r + " _" + i + "_" + s.idx + " mCS-autoHide mCS-dir-rtl mCS_no_scrollbar mCS_disabled").addClass("mCS_destroyed")
                            }
                        })
                    }
                },
                d = {
                    ...
                    _theme: function(e) {
                        ...
                        e.autoDraggerLength = n.inArray(e.theme, t) > -1 ? !1 : e.autoDraggerLength, e.autoExpandScrollbar = n.inArray(e.theme, r) > -1 ? !1 : e.autoExpandScrollbar, e.scrollButtons.enable = n.inArray(e.theme, i) > -1 ? !1 : e.scrollButtons.enable, e.autoHideScrollbar = n.inArray(e.theme, s) > -1 ? !0 : e.autoHideScrollbar, e.scrollbarPosition = n.inArray(e.theme, o) > -1 ? "outside" : e.scrollbarPosition
                    },
                    ...
                    _pluginMarkup: function() {
                        var e = n(this),
                            t = e.data(i),
                            s = t.opt,
                            o = s.autoExpandScrollbar ? " mCSB_scrollTools_onDrag_expand" : "",
                            ...
                            a = s.axis === "yx" ? "mCSB_vertical_horizontal" : s.axis === "x" ? "mCSB_horizontal" : "mCSB_vertical",
                            f = s.axis === "yx" ? u[0] + u[1] : s.axis === "x" ? u[1] : u[0],
                            l = s.axis === "yx" ? "<div id='mCSB_" + t.idx + "_container_wrapper' class='mCSB_container_wrapper' />" : "",
                            c = s.autoHideScrollbar ? " mCS-autoHide" : "",
                            h = s.axis !== "x" && t.langDir === "rtl" ? " mCS-dir-rtl" : "";
                        s.setWidth && e.css("width", s.setWidth), s.setHeight && e.css("height", s.setHeight), s.setLeft = s.axis !== "y" && t.langDir === "rtl" ? "989999px" : s.setLeft, e.addClass(r + " _" + i + "_" + t.idx + c + h).wrapInner("<div id='mCSB_" + t.idx + "' class='mCustomScrollBox mCS-" + s.theme + " " + a + "'><div id='mCSB_" + t.idx + "_container' class='mCSB_container' style='position:relative; top:" + s.setTop + "; left:" + s.setLeft + ";' dir=" + t.langDir + " /></div>");
                        var p = n("#mCSB_" + t.idx),
                            v = n("#mCSB_" + t.idx + "_container");
                        s.axis !== "y" && !s.advanced.autoExpandHorizontalScroll && v.css("width", d._contentWidth(v.children())), s.scrollbarPosition === "outside" ? (e.css("position") === "static" && e.css("position", "relative"), e.css("overflow", "visible"), p.addClass("mCSB_outside").after(f)) : (p.addClass("mCSB_inside").append(f), v.wrap(l)), d._scrollButtons.call(this);
                        var m = [n("#mCSB_" + t.idx + "_dragger_vertical"), n("#mCSB_" + t.idx + "_dragger_horizontal")];
                    ...
                    _expandContentHorizontally: function() {
                        var e = n(this),
                            ...
                            r = t.opt,
                            s = n("#mCSB_" + t.idx + "_container");
                        r.advanced.autoExpandHorizontalScroll && r.axis !== "y" && s.css({
                            position: "absolute",
                            width: "auto"
                    ...
                    _scrollButtons: function() {
                        var e = n(this),
                            ...
                            o = ["<a href='#' class='mCSB_buttonUp' oncontextmenu='return false;' />", "<a href='#' class='mCSB_buttonDown' oncontextmenu='return false;' />", "<a href='#' class='mCSB_buttonLeft' oncontextmenu='return false;' />", "<a href='#' class='mCSB_buttonRight' oncontextmenu='return false;' />"],
                            u = [r.axis === "x" ? o[2] : o[0], r.axis === "x" ? o[3] : o[1], o[2], o[3]];
                        r.scrollButtons.enable && s.prepend(u[0]).append(u[1]).next(".mCSB_scrollTools").prepend(u[2]).append(u[3])
                    },
                    _maxHeight: function() {
                        var e = n(this),
                            t = e.data(i),
                            ...
                            a = e.css("box-sizing");
                        if (o !== "none") {
                            var f = u ? e.parent().height() * parseInt(o) / 100 : parseInt(o);
                            a === "border-box" && (f -= e.innerHeight() - e.height() + (e.outerHeight() - e.innerHeight())), s.css("max-height", Math.round(f))
                        }
                    },
                    ...
                    _onDragClasses: function(e, t, n) {
                        ...
                        t === "active" ? (e.toggleClass(i[0] + " " + r), s.toggleClass(i[1]), e[0]._draggable = e[0]._draggable ? 0 : 1) : e[0]._draggable || (t === "hide" ? (e.removeClass(i[0]), s.removeClass(i[1])) : (e.addClass(i[0]), s.addClass(i[1])))
                    },
                    ...
                    _resetContentPosition: function() {
                        var e = n(this),
                            ...
                            u = [n("#mCSB_" + t.idx + "_dragger_vertical"), n("#mCSB_" + t.idx + "_dragger_horizontal")];
                        d._stop(e), (r.axis !== "x" && !t.overflowed[0] || r.axis === "y" && t.overflowed[0]) && u[0].add(o).css("top", 0);
                        if (r.axis !== "y" && !t.overflowed[1] || r.axis === "x" && t.overflowed[1]) {
                            var a = dx = 0;
                            t.langDir === "rtl" && (a = s.width() - o.outerWidth(!1), dx = Math.abs(a / t.scrollRatio.x)), o.css("left", a), u[1].css("left", dx)
                        }
                    },
                    _bindEvents: function() {
                        var e = n(this),
                            ...
                            r = t.opt;
                        if (!t.bindEvents) {
                            d._draggable.call(this), r.contentTouchScroll && d._contentDraggable.call(this);
                            if (r.mouseWheel.enable) {
                                function s() {
                                    o = setTimeout(function() {
                                        n.event.special.mousewheel ? (clearTimeout(o), d._mousewheel.call(e[0])) : s()
                                    }, 1e3)
                                }
                                var o;
                                s()
                            }
                            d._draggerRail.call(this), d._wrapperScroll.call(this), r.advanced.autoScrollOnFocus && d._focus.call(this), r.scrollButtons.enable && d._buttons.call(this), r.keyboard.enable && d._keyboard.call(this), t.bindEvents = !0
                        }
                    },
                    _unbindEvents: function() {
                        var e = n(this),
                            ...
                            u = n("#mCSB_" + r.idx + ",#mCSB_" + r.idx + "_container,#mCSB_" + r.idx + "_container_wrapper," + o + " .mCSB_draggerContainer,#mCSB_" + r.idx + "_dragger_vertical,#mCSB_" + r.idx + "_dragger_horizontal," + o + ">a"),
                            f = n("#mCSB_" + r.idx + "_container");
                        r.bindEvents && (n(t).unbind("." + s), u.each(function() {
                            n(this).unbind("." + s)
                        }), clearTimeout(e[0]._focusTimeout), d._delete.call(null, e[0]._focusTimeout), clearTimeout(r.sequential.step), d._delete.call(null, r.sequential.step), clearTimeout(f[0].onCompleteTimeout), d._delete.call(null, f[0].onCompleteTimeout), r.bindEvents = !1)
                    },
                    _scrollbarVisibility: function(e) {
                        var t = n(this),
                            ...
                            a = [n("#mCSB_" + r.idx + "_scrollbar_vertical"), n("#mCSB_" + r.idx + "_scrollbar_horizontal")],
                            f = [a[0].find(".mCSB_dragger"), a[1].find(".mCSB_dragger")];
                        s.axis !== "x" && (r.overflowed[0] && !e ? (a[0].add(f[0]).add(a[0].children("a")).css("display", "block"), u.removeClass("mCS_no_scrollbar_y mCS_y_hidden")) : (s.alwaysShowScrollbar ? (s.alwaysShowScrollbar !== 2 && f[0].add(a[0].children("a")).css("display", "none"), u.removeClass("mCS_y_hidden")) : (a[0].css("display", "none"), u.addClass("mCS_y_hidden")), u.addClass("mCS_no_scrollbar_y"))), s.axis !== "y" && (r.overflowed[1] && !e ? (a[1].add(f[1]).add(a[1].children("a")).css("display", "block"), u.removeClass("mCS_no_scrollbar_x mCS_x_hidden")) : (s.alwaysShowScrollbar ? (s.alwaysShowScrollbar !== 2 && f[1].add(a[1].children("a")).css("display", "none"), u.removeClass("mCS_x_hidden")) : (a[1].css("display", "none"), u.addClass("mCS_x_hidden")), u.addClass("mCS_no_scrollbar_x"))), !r.overflowed[0] && !r.overflowed[1] ? t.addClass("mCS_no_scrollbar") : t.removeClass("mCS_no_scrollbar")
                    },
                    ...
                    _draggable: function() {
                        ...
                        var e = n(this),
                            ...
                            l = n("#" + u[0] + ",#" + u[1]),
                            p, v, m;
                        l.bind("mousedown." + o + " touchstart." + o + " pointerdown." + o + " MSPointerDown." + o, function(r) {
                            r.stopImmediatePropagation(), r.preventDefault();
                            if (!d._mouseBtnLeft(r)) return;
                            h = !0, c && (t.onselectstart = function() {
                                return !1
                            }), g(!1), d._stop(e), p = n(this);
                            var i = p.offset(),
                                o = d._coordinates(r)[0] - i.top,
                                u = d._coordinates(r)[1] - i.left,
                                f = p.height() + i.top,
                                l = p.width() + i.left;
                            o < f && o > 0 && u < l && u > 0 && (v = o, m = u), d._onDragClasses(p, "active", s.autoExpandScrollbar)
                            ...
                            y(v, m, n, r)
                        }), n(t).bind("mousemove." + o + " pointermove." + o + " MSPointerMove." + o, function(e) {
                            if (p) {
                                var t = p.offset(),
                                    n = d._coordinates(e)[0] - t.top,
                                    r = d._coordinates(e)[1] - t.left;
                        ...
                        }).add(l).bind("mouseup." + o + " touchend." + o + " pointerup." + o + " MSPointerUp." + o, function(e) {
                            p && (d._onDragClasses(p, "active", s.autoExpandScrollbar), p = null), h = !1, c && (t.onselectstart = null), g(!0)
                        })
                    },
                    _contentDraggable: function() {
                        ...
                        var e = n(this),
                            ...
                            m = [],
                            g, y, b, w, E, S, x = 0,
                            T, N = r.axis === "yx" ? "none" : "all";
                        u.bind("touchstart." + s + " pointerdown." + s + " MSPointerDown." + s, function(e) {
                            if (!d._pointerTouch(e) || h) return;
                            var t = u.offset();
                            f = d._coordinates(e)[0] - t.top, l = d._coordinates(e)[1] - t.left
                            ...
                            var n = o.offset(),
                                ...
                                c = "mcsLinearOut";
                            v.push(i), m.push(s);
                            if (t.overflowed[0]) var p = a[0].parent().height() - a[0].height(),
                                g = f - i > 0 && i - f > -(p * t.scrollRatio.y);
                            if (t.overflowed[1]) var b = a[1].parent().width() - a[1].width(),
                                w = l - s > 0 && s - l > -(b * t.scrollRatio.x);
                            (g || w) && e.preventDefault(), S = r.axis === "yx" ? [f - i, l - s] : r.axis === "x" ? [null, l - s] : [f - i, null], u[0].idleTimer = 250, t.overflowed[0] && k(S[0], x, c, "y", "all", !0), t.overflowed[1] && k(S[1], x, c, "x", N, !0)
                        }), o.bind("touchstart." + s + " pointerdown." + s + " MSPointerDown." + s, function(t) {
                            if (!d._pointerTouch(t) || h) return;
                            t.stopImmediatePropagation(), d._stop(e), g = d._getTime();
                            var n = o.offset();
                            c = d._coordinates(t)[0] - n.top, p = d._coordinates(t)[1] - n.left, v = [], m = []
                            ...
                            var O = [Math.abs(u[0].offsetTop) - w[0] * C(x[0] / E[0], E[0]), Math.abs(u[0].offsetLeft) - w[1] * C(x[1] / E[1], E[1])];
                            S = r.axis === "yx" ? [O[0], O[1]] : r.axis === "x" ? [null, O[1]] : [O[0], null], T = [x[0] * 4 + r.scrollInertia, x[1] * 4 + r.scrollInertia];
                            var _ = parseInt(r.contentTouchScroll) || 0;
                            S[0] = x[0] > _ ? S[0] : 0, S[1] = x[1] > _ ? S[1] : 0, t.overflowed[0] && k(S[0], T[0], a, "y", N, !1), t.overflowed[1] && k(S[1], T[1], a, "x", N, !1)
                        })
                    },
                    _mousewheel: function() {
                        ...
                        if (t) {
                            ...
                            o.bind("mousewheel." + s, function(i, s) {
                                ...
                                var a = r.mouseWheel.deltaFactor !== "auto" ? parseInt(r.mouseWheel.deltaFactor) : c && i.deltaFactor < 100 ? 100 : i.deltaFactor < 40 ? 40 : i.deltaFactor || 100;
                                if (r.axis === "x" || r.mouseWheel.axis === "x") var f = "x",
                                    l = [Math.round(a * t.scrollRatio.x), parseInt(r.mouseWheel.scrollAmount)],
                                    h = r.mouseWheel.scrollAmount !== "auto" ? l[1] : l[0] >= o.width() ? o.width() * .9 : l[0],
                                    p = Math.abs(n("#mCSB_" + t.idx + "_container")[0].offsetLeft),
                                    v = u[1][0].offsetLeft,
                                    m = u[1].parent().width() - u[1].width(),
                                    g = i.deltaX || i.deltaY || s;
                                else var f = "y",
                                    l = [Math.round(a * t.scrollRatio.y), parseInt(r.mouseWheel.scrollAmount)],
                                    h = r.mouseWheel.scrollAmount !== "auto" ? l[1] : l[0] >= o.height() ? o.height() * .9 : l[0],
                                    p = Math.abs(n("#mCSB_" + t.idx + "_container")[0].offsetTop),
                                    v = u[0][0].offsetTop,
                                    m = u[0].parent().height() - u[0].height(),
                                    g = i.deltaY || s;
                                if (f === "y" && !t.overflowed[0] || f === "x" && !t.overflowed[1]) return;
                                r.mouseWheel.invert && (g = -g), r.mouseWheel.normalizeDelta && (g = g < 0 ? -1 : 1);
                                if (g > 0 && v !== 0 || g < 0 && v !== m || r.mouseWheel.preventDefault) i.stopImmediatePropagation(), i.preventDefault();
                                d._scrollTo(e, (p - g * h).toString(), {
                                    dir: f
                                })
                            })
                        }
                    ...
                    _disableMousewheel: function(e, t) {
                        var r = t.nodeName.toLowerCase(),
                            ...
                            o = ["select", "textarea"];
                        return n.inArray(r, s) > -1 && !(n.inArray(r, o) > -1 && !n(t).is(":focus"))
                    },
                    _draggerRail: function() {
                        ...
                        u.bind("touchstart." + r + " pointerdown." + r + " MSPointerDown." + r, function(e) {
                            h = !0
                        }).bind("touchend." + r + " pointerup." + r + " MSPointerUp." + r, function(e) {
                            h = !1
                        }).bind("click." + r, function(r) {
                            if (n(r.target).hasClass("mCSB_draggerContainer") || n(r.target).hasClass("mCSB_draggerRail")) {
                                d._stop(e);
                                var i = n(this),
                                ...
                                if (i.parent(".mCSB_scrollTools_horizontal").length > 0) {
                                    ...
                                    var a = "x",
                                        ...
                                        l = Math.abs(s[0].offsetLeft) - f * o.width() * .9
                                } else {
                                    if (!t.overflowed[0]) return;
                                    var a = "y",
                                        f = r.pageY > u.offset().top ? -1 : 1,
                                        l = Math.abs(s[0].offsetTop) - f * o.height() * .9
                                }
                                d._scrollTo(e, l.toString(), {
                                    dir: a,
                                    scrollEasing: "mcsEaseInOut"
                    ...
                    _focus: function() {
                        ...
                        u.bind("focusin." + o, function(r) {
                            ...
                            d._stop(e), clearTimeout(e[0]._focusTimeout), e[0]._focusTimer = o ? (l + 17) * o : 0, e[0]._focusTimeout = setTimeout(function() {
                                var t = [i.offset().top - u.offset().top, i.offset().left - u.offset().left],
                                    n = [u[0].offsetTop, u[0].offsetLeft],
                                    r = [n[0] + t[0] >= 0 && n[0] + t[0] < f.height() - i.outerHeight(!1), n[1] + t[1] >= 0 && n[0] + t[1] < f.width() - i.outerWidth(!1)],
                                    o = s.axis === "yx" && !r[0] && !r[1] ? "none" : "all";
                                s.axis !== "x" && !r[0] && d._scrollTo(e, t[0].toString(), {
                                    dir: "y",
                                    scrollEasing: "mcsEaseInOut",
                                    overwrite: o,
                                    dur: l
                                }), s.axis !== "y" && !r[1] && d._scrollTo(e, t[1].toString(), {
                                    dir: "x",
                                    scrollEasing: "mcsEaseInOut",
                                    overwrite: o,
                                    dur: l
                    ...
                    _buttons: function() {
                        var e = n(this),
                            ...
                            f = n(a + ">a");
                        f.bind("mousedown." + o + " touchstart." + o + " pointerdown." + o + " MSPointerDown." + o + " mouseup." + o + " touchend." + o + " pointerup." + o + " MSPointerUp." + o + " mouseout." + o + " pointerout." + o + " MSPointerOut." + o + " click." + o, function(i) {
                            function u(t, n) {
                                s.scrollAmount = r.snapAmount || r.scrollButtons.scrollAmount, d._sequentialScroll.call(this, e, t, n)
                            }
                            i.preventDefault();
                            ...
                            switch (i.type) {
                                ...
                                case "keyup":
                                    var u = i.keyCode ? i.keyCode : i.which,
                                        f = "on";
                                    if (s.axis !== "x" && (u === 38 || u === 40) || s.axis !== "y" && (u === 37 || u === 39)) {
                                        if ((u === 38 || u === 40) && !r.overflowed[0] || (u === 37 || u === 39) && !r.overflowed[1]) return;
                                        i.type === "keyup" && (f = "off"), n(t.activeElement).is(h) || (i.preventDefault(), i.stopImmediatePropagation(), y(f, u))
                                    } else if (u === 33 || u === 34) {
                                        if (r.overflowed[0] || r.overflowed[1]) i.preventDefault(), i.stopImmediatePropagation();
                                        if (i.type === "keyup") {
                                            d._stop(e);
                                            var p = u === 34 ? -1 : 1;
                                            if (s.axis === "x" || s.axis === "yx" && r.overflowed[1] && !r.overflowed[0]) var m = "x",
                                                g = Math.abs(l[0].offsetLeft) - p * c.width() * .9;
                                            else var m = "y",
                                                g = Math.abs(l[0].offsetTop) - p * c.height() * .9;
                                        ...
                                        if (!n(t.activeElement).is(h)) {
                                            ...
                                            if (i.type === "keyup") {
                                                if (s.axis === "x" || s.axis === "yx" && r.overflowed[1] && !r.overflowed[0]) var m = "x",
                                                    g = u === 35 ? Math.abs(c.width() - l.outerWidth(!1)) : 0;
                                                else var m = "y",
                                                    g = u === 35 ? Math.abs(c.height() - l.outerHeight(!1)) : 0;
                                                d._scrollTo(e, g.toString(), {
                                                    dir: m,
                                                    scrollEasing: "mcsEaseInOut"
                                                })
                    ...
                    _sequentialScroll: function(e, t, r) {
                        function l(t) {
                            var n = u.type !== "stepped",
                                r = t ? n ? o.scrollInertia / 1.5 : o.scrollInertia : 1e3 / 60,
                                i = t ? n ? 7.5 : 40 : 2.5,
                                f = [Math.abs(a[0].offsetTop), Math.abs(a[0].offsetLeft)],
                                c = [s.scrollRatio.y > 10 ? 10 : s.scrollRatio.y, s.scrollRatio.x > 10 ? 10 : s.scrollRatio.x],
                                h = u.dir[0] === "x" ? f[1] + u.dir[1] * c[1] * i : f[0] + u.dir[1] * c[0] * i,
                                p = u.dir[0] === "x" ? f[1] + u.dir[1] * parseInt(u.scrollAmount) : f[0] + u.dir[1] * parseInt(u.scrollAmount),
                                v = u.scrollAmount !== "auto" ? p : h,
                                m = t ? n ? "mcsLinearOut" : "mcsEaseInOut" : "mcsLinear",
                                g = t ? !0 : !1;
                            t && r < 17 && (v = u.dir[0] === "x" ? f[1] : f[0]), d._scrollTo(e, v.toString(), {
                                dir: u.dir[0],
                                scrollEasing: m,
                                dur: r,
                                onComplete: g
                        ...
                        switch (t) {
                            case "on":
                                u.dir = [r === "mCSB_buttonRight" || r === "mCSB_buttonLeft" || r === 39 || r === 37 ? "x" : "y", r === "mCSB_buttonUp" || r === "mCSB_buttonLeft" || r === 38 || r === 37 ? -1 : 1], d._stop(e);
                    ...
                    _arr: function(e) {
                        var t = n(this).data(i).opt,
                            r = [];
                        return typeof e == "function" && (e = e()), e instanceof Array ? r = e.length > 1 ? [e[0], e[1]] : t.axis === "x" ? [null, e[0]] : [e[0], null] : (r[0] = e.y ? e.y : e.x || t.axis === "x" ? null : e, r[1] = e.x ? e.x : e.y || t.axis === "y" ? null : e), typeof r[0] == "function" && (r[0] = r[0]()), typeof r[1] == "function" && (r[1] = r[1]()), r
                    },
                    _to: function(e, t) {
                        ...
                        switch (f) {
                            case "function":
                                return e();
                            case "object":
                                if (e.nodeType) var m = t === "x" ? n(e).offset().left : n(e).offset().top;
                                else if (e.jquery) {
                                    if (!e.length) return;
                            ...
                            case "number":
                                ...
                                if (e.indexOf("%") !== -1) return Math.abs(l * parseInt(e) / 100);
                                if (e.indexOf("-=") !== -1) return Math.abs(h - parseInt(e.split("-=")[1]));
                                if (e.indexOf("+=") !== -1) {
                                    var g = h + parseInt(e.split("+=")[1]);
                                    return g >= 0 ? 0 : Math.abs(g)
                                }
                                if (e.indexOf("px") !== -1 && d._isNumeric.call(null, e.split("px")[0])) return Math.abs(e.split("px")[0]);
                                if (e === "top" || e === "left") return 0;
                                if (e === "bottom") return Math.abs(a.height() - u.outerHeight(!1));
                                if (e === "right") return Math.abs(a.width() - u.outerWidth(!1));
                                if (e === "first" || e === "last") {
                                    var y = u.find(":" + e),
                    ...
                    _autoUpdate: function(e) {
                        function y() {
                            clearTimeout(o[0].autoUpdate), o[0].autoUpdate = setTimeout(function() {
                                ...
                                if (s.advanced.updateOnContentResize) {
                                    v = [o.outerHeight(!1), o.outerWidth(!1), u.height(), u.width(), f()[0], f()[1]];
                                    if (v[0] !== h[0] || v[1] !== h[1] || v[2] !== h[2] || v[3] !== h[3] || v[4] !== h[4] || v[5] !== h[5]) S(), h = v
                                }
                                s.advanced.updateOnImageLoad && (g = b(), g !== m && (o.find("img").each(function() {
                                    w(this.src)
                                }), m = g)), (s.advanced.updateOnSelectorChange || s.advanced.updateOnContentResize || s.advanced.updateOnImageLoad) && y()
                            }, 60)
                        }

                        function b() {
                            var e = 0;
                            return s.advanced.updateOnImageLoad && (e = o.find("img").length), e
                        }
                        ...
                        function E() {
                            s.advanced.updateOnSelectorChange === !0 && (s.advanced.updateOnSelectorChange = "*");
                            var e = 0,
                        ...
                        if (e) {
                            clearTimeout(o[0].autoUpdate), d._delete.call(null, o[0].autoUpdate);
                            return
                        }
                        var u = o.parent(),
                            a = [n("#mCSB_" + r.idx + "_scrollbar_vertical"), n("#mCSB_" + r.idx + "_scrollbar_horizontal")],
                            f = function() {
                                return [a[0].is(":visible") ? a[0].outerHeight(!0) : 0, a[1].is(":visible") ? a[1].outerWidth(!0) : 0]
                            },
                            l = E(),
                            c, h = [o.outerHeight(!1), o.outerWidth(!1), u.height(), u.width(), f()[0], f()[1]],
                            v, m = b(),
                            g;
                        y()
                    },
                    ...
                    _stop: function(e) {
                        var t = e.data(i),
                            r = n("#mCSB_" + t.idx + "_container,#mCSB_" + t.idx + "_container_wrapper,#mCSB_" + t.idx + "_dragger_vertical,#mCSB_" + t.idx + "_dragger_horizontal");
                        r.each(function() {
                    ...
                    _scrollTo: function(e, t, r) {
                        ...
                        function T() {
                            return [o.callbacks.alwaysTriggerOffsets || m >= g[0] + b, o.callbacks.alwaysTriggerOffsets || m <= -w]
                        }
                        ...
                        function N() {
                            ...
                            e[0].mcs = {
                                ...
                                draggerTop: n[0],
                                draggerLeft: n[1],
                                topPct: Math.round(100 * Math.abs(t[0]) / (Math.abs(i[0]) - s[0])),
                                leftPct: Math.round(100 * Math.abs(t[1]) / (Math.abs(i[1]) - s[1])),
                                direction: r.dir
                            }
                        }
                        var s = e.data(i),
                            ...
                            c = o.callbacks.onTotalScrollOffset ? d._arr.call(e, o.callbacks.onTotalScrollOffset) : [0, 0],
                            h = o.callbacks.onTotalScrollBackOffset ? d._arr.call(e, o.callbacks.onTotalScrollBackOffset) : [0, 0];
                        s.trigger = r.trigger, o.snapAmount && (t = d._snapAmount(t, o.snapAmount, o.snapOffset));
                        switch (r.dir) {
                            case "x":
                                var p = n("#mCSB_" + s.idx + "_dragger_horizontal"),
                                    v = "left",
                                    m = l[0].offsetLeft,
                                    g = [f.width() - l.outerWidth(!1), p.parent().width() - p.width()],
                            ...
                            case "y":
                                var p = n("#mCSB_" + s.idx + "_dragger_vertical"),
                                    v = "top",
                                    m = l[0].offsetTop,
                                    g = [f.height() - l.outerHeight(!1), p.parent().height() - p.height()],
                        ...
                        y[1] < 0 ? y = [0, 0] : y[1] >= g[1] ? y = [g[0], g[1]] : y[0] = -y[0], clearTimeout(l[0].onCompleteTimeout);
                        if (!s.tweenRunning && (m === 0 && y[0] >= 0 || m === g[0] && y[0] <= g[0])) return;
                        d._tweenTo.call(null, p[0], v, Math.round(y[1]), a[1], r.scrollEasing), d._tweenTo.call(null, l[0], v, Math.round(y[0]), a[0], r.scrollEasing, r.overwrite, {
                            onStart: function() {
                                r.callbacks && r.onStart && !s.tweenRunning && (x("onScrollStart") && (N(), o.callbacks.onScrollStart.call(e[0])), s.tweenRunning = !0, d._onDragClasses(p), s.cbOffsets = T())
                            },
                            onUpdate: function() {
                                r.callbacks && r.onUpdate && x("whileScrolling") && (N(), o.callbacks.whileScrolling.call(e[0]))
                            },
                            onComplete: function() {
                                if (r.callbacks && r.onComplete) {
                                    ...
                                    l[0].onCompleteTimeout = setTimeout(function() {
                                        x("onScroll") && (N(), o.callbacks.onScroll.call(e[0])), x("onTotalScroll") && y[1] >= g[1] - E && s.cbOffsets[0] && (N(), o.callbacks.onTotalScroll.call(e[0])), x("onTotalScrollBack") && y[1] <= S && s.cbOffsets[1] && (N(), o.callbacks.onTotalScrollBack.call(e[0])), s.tweenRunning = !1, l[0].idleTimer = 0, d._onDragClasses(p, "hide")
                                    }, t)
                                }
                            }
                        })
                    ...
                    _tweenTo: function(t, n, r, i, s, o, u) {
                        function y() {
                            ...
                            p || a.call(), p = d._getTime() - c, w(), p >= t._mcstime && (t._mcstime = p > t._mcstime ? p + h - (p - t._mcstime) : p + h - 1, t._mcstime < p + 1 && (t._mcstime = p + 1)), t._mcstime < i ? t._mcsid = _request(y) : l.call()
                        }

                        function w() {
                            i > 0 ? (t._mcscurrVal = x(t._mcstime, v, g, i, s), m[n] = Math.round(t._mcscurrVal) + "px") : m[n] = r + "px", f.call()
                        }

                        function E() {
                            h = 1e3 / 60, t._mcstime = p + h, _request = e.requestAnimationFrame ? e.requestAnimationFrame : function(e) {
                        ...
                        function S() {
                            ...
                            e.requestAnimationFrame ? e.cancelAnimationFrame(t._mcsid) : clearTimeout(t._mcsid), t._mcsid = null
                        }
                    ...
                    _stopTween: function() {
                        var t = this;
                        if (t._mcsid == null) return;
                        e.requestAnimationFrame ? e.cancelAnimationFrame(t._mcsid) : clearTimeout(t._mcsid), t._mcsid = null, t._mcsstop = 1
                    },
                    _delete: function(e) {
                        try {
                            delete e
            ...
            n.fn[r] = function(e) {
                ...
                if (typeof e == "object" || !e) return p.init.apply(this, arguments);
                n.error("Method " + e + " does not exist")
            }, n[r].defaults = o, e[r] = !0, n(e).load(function() {
                n(s)[r]()
            })
        })
    }(window, document), define("products/products", ["jquery", "products/defineCategories", "products/collection/categoryCollection", "products/models/categoryModel", "products/views/categoryListView", "products/views/categorySliderView", "products/collection/itemsCollection", "products/collection/formCollection", "products/views/modalView", "products/models/formModel", "products/views/formView", "owlCarousel", "waitImg", "velocity", "underscore", "scroll"], function(e, t, n, r, i, s, o, u, a, f, l) {
        var c = {
            ...
            h = {
                init: function() {
                    window.ItemsCollection = new o, e.each(t, function() {
                        var e = new r;
                        e.set({
                            name: this.name,
                    ...
                    var n = new i({
                        collection: c.categoryCollection
                    });
                    e(".js-category-list").html(n.render().el);
                    var s = c.categoryCollection.first();
                    this.loadCategory(s, !0), e(window).on("loadNewCategory", function(e, t) {
                        e.preventDefault(), h.changeCategories.hide(c.categoryCollection.get({
                            cid: t
                        }), t)
                    }), this.showProductDetails(), e(window).on("addToCart", function(e, t) {
                        e.preventDefault();
                        var n = window.ItemsCollection.get({
                            cid: t
                        });
                        h.addToCart.addToList(n.get("name"), n.get("price").current, n.get("code"), t), c.formCollection.trigger("itemAdded")
                    ...
                    }), e(".js-order-container").mCustomScrollbar(), e(window).on("fillField", function() {
                        e("#prCode_field").val("");
                        var t = [];
                        ...
                        c.formCollection.reset(), h.cart.getLength(0), h.cart.getTotal(), e(".js-order-list li").wrapAll('<div class="extra-wrapper"></div>'), e(".extra-wrapper").velocity({
                            scale: "0.8",
                            opacity: "0"
                        }, 500, function() {
                ...
                cart: {
                    getLength: function(t) {
                        e(".js-product-count").html(t), e("#products .products-number").hasClass("animated bounce") || (e("#products .products-number").addClass("animated bounce"), setTimeout(function() {
                            e("#products .products-number").removeClass("animated bounce")
                        }, 1500))
                    },
                    getTotal: function() {
                        var t = 0;
                ...
                addToCart: {
                    ...
                    showForm: function() {
                        var t = new l({
                            collection: c.formCollection
                        });
                        e(".js-order-container .mCSB_container").append(t.render().el), e(".products-form").addClass("active")
                    },
                    hideForm: function() {
                        e(".products-form").removeClass("active"), setTimeout(function() {
                ...
                showProductDetails: function() {
                    e(window).on("showProductItem", function(t, n) {
                        t.preventDefault();
                        var r = window.ItemsCollection.get({
                                cid: n
                            }),
                            i = new a({
                                model: r
                            });
                        e(".product-details-modal").append(i.render().el), e(".product-details-modal .images-list").waitForImages(function() {
                            ...
                            translateX: ["0", "-100%"]
                        }, 700, [.7, 0, .3, 1], function() {
                            e(".product-details-modal").css("overflow-y", "scroll"), e("body").css("overflow", "hidden")
                        }), e(".close-details", e(".product-details-modal")).click(function() {
                            e(".product-details-modal").css("overflow", "hidden"), e("body").css("overflow-y", "visible"), e(".product-details-modal").velocity("reverse", function() {
                                e(".details-container", e(".product-details-modal")).remove()
                            })
                        })
                    })
                },
                changeCategories: {
                    hide: function(t, n) {
                        t.get("loaded") || (e(".options-list").css("opacity", "0"), e(".loader").fadeIn(300)), h.loadCategory(t, !1)
                    },
                    show: function(t) {
                        c.curentCat.remove(), c.nextCat.show(), c.curentCat = c.nextCat, h.checkNavNeed(c.curentCat), t || c.curentCat.trigger("categoryChanged"), e(".products-category-list").removeClass("active"), t && setTimeout(function() {
                            e(".options-list").css("opacity", "1"), e(".loader").fadeOut(10)
                        }, 700)
                    }
                },
                loadCategory: function(t, n) {
                    ...
                    this.initCategoryCarousel(o), n ? c.curentCat = o : (c.nextCat = o, c.nextCat.waitForImages(function() {
                ...
                initCategoryCarousel: function(t) {
                    ...
                    e(".slides", t).owlCarousel(n), t.on("categoryChanged", function() {
                        var r = e(".slides", t);
                        r.data("owlCarousel").destroy(), r.removeClass("owl-carousel owl-loaded owl-text-select-on"), r.find(".owl-stage-outer").children().unwrap(), r.owlCarousel(n), h.checkNavNeed(t)
        ...
        shim: {
            ...
            circleTimer: ["jquery"],
            velocityUi: {
                depse: ["jquery", "velocity"]
            },
            SmoothScroll: ["jquery"],
            scroll: ["jquery"],
            defineCategories: ["jquery"]
        }
    }), require(["components/menuScript", "components/basicBind", "components/sliderScript", "components/getinTouch", "components/customSelect", "components/headerScript", "components/bgVideo", "components/mobileMenu", "components/preloader", "components/timer", "products/products"], function() {}), define("script", function() {});
